...
class ExampleMultipeerSession: NSObject, ObservableObject {
    private let serviceType = "exmulti-service"
    ...
    @Published var receivedPlant: Plant = Plant(name: "", desc: "", location: "")
...
extension ExampleMultipeerSession: MCNearbyServiceAdvertiserDelegate {
...
extension ExampleMultipeerSession: MCNearbyServiceBrowserDelegate {
...
extension ExampleMultipeerSession: MCSessionDelegate {
    ...
    func session(_ session: MCSession, didReceive data: Data, fromPeer peerID: MCPeerID) {
        if let string = String(data: data, encoding: .utf8),
           let plant: Plant? = Plant(name: string, desc: string, location: string) {
